...
<header>
	...
	<form action="adminShopDetailUpdateConfirm" class="form-signin">
		<img class="mb-4"
	...
	<label class="mr-sm-2" for="inlineFormCustomSelect">料理画像</label>
		...
		<div class="col">
		<button class="btn btn-lg btn-default btn-block" type="button" onclick="location.href='adminShopDetailUpdate'">戻る</button>
		</div>
		</div>
