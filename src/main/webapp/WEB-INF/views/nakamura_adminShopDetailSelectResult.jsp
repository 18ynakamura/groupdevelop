...
<header>
	...
	<form action="adminShopDetailSelectResult" class="form-signin">
		<img class="mb-4"
			src="https://getbootstrap.com/assets/brand/bootstrap-solid.svg"
			alt="" width="72" height="72">
		<h1 class="h3 mb-3 font-weight-normal"></h1><br><br>
		<h1 class="h3 mb-3 font-weight-normal">検索結果</h1><br><br>
		<div class="row">
		<div class="col">
	...
	<label class="mr-sm-2" for="inlineFormCustomSelect">料理画像</label>
		<input class="form-control" type="text" value="example.jpg" readonly>
		</div>
		<div class="col">
		<label class="mr-sm-2" for="inlineFormCustomSelect">店内画像</label>
		<input class="form-control" type="text" value="example.png" readonly>
		</div>
		</div><br>
		<br>
		<div class="row">
		<div class="col">
		<button class="btn btn-lg btn-warning btn-block" type="button" onclick="location.href='adminShopDetailUpdate'">更新</button>
		</div>
		<div class="col">
		<button class="btn btn-lg btn-warning btn-block" type="button" onclick="location.href='adminShopDetailDelete'">削除</button>
		</div>
		<div class="col">
		<button class="btn btn-lg btn-warning btn-block" type="button" onclick="location.href='adminAnalyzingSelectMonth'">分析データ</button>
		</div>
		<div class="col">
